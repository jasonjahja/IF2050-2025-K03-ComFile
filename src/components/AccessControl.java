...
public class AccessControl extends JDialog {
    ...
    public AccessControl(JFrame parent, String docTitle, Map<String, Document.User> users) {
        ...
        addPeopleField.addActionListener(e -> {
            ...
            if (!username.isEmpty() && users.containsKey(username)) {
                ...
                peopleListPanel.add(createPersonRow(user.getUsername(), user.getRole()));
        ...
        // === Owner row
        ownerRowPanel = createPersonRow("usernameuser", "Owner");
        ...
        String[] groups = {"Finance Team", "IT Team", "HR Team", "All Staff", "Managers"};
        String[] roles = {"Viewer", "Editor", "Remove Access"};
    ...
    private JPanel createPersonRow(String username, String role) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            new AccessControl(dummyFrame, "File Name", Document.users);
